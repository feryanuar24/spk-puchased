...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
  ...
  <a href="#" class="brand-link">
    <div class="row">
      <div class="bg-light rounded-circle col-3 mx-3 p-2">
        <img src="<?= base_url() ?>assets/dist/img/nb.png" alt="AdminLTE Logo" class="w-100">
      </div>
      <div class="col d-flex align-items-center">
        <div class="brand-text font-weight-light">NAIVE BAYES</div>
      </div>
    </div>
  </a>
